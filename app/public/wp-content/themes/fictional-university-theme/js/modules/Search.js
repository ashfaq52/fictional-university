...
class Search {
    ...
    getResults(){
            ...
            this.resultsDiv.html(`
                <div class="row">
                    ...
                    <div class="one-third">
                        ...
                        ${results.professors.length ? '<ul style="padding: 10px 10px 0px 0px;' : `<p>No professors match that search.</p>`}
                        ...
                        ${results.events.length ? '' : `<p>No events match that search. <a href="${universityData.root_url}/events" >View all events</a></p>`}
                            ...
                            <div class="event-summary">
                                <a class="event-summary__date t-center" href="${item.permalink}">
                                    ...
                                    <span class="event-summary__day">${item.day}</span></span>
                                </a>
        ...
        // ).then((posts, pages) => {
        //     //how to combine multiple arrays: '.concat'
        //     var combinedResults = posts[0].concat(pages[0]);
        //     this.resultsDiv.html(`
        //         <h2 class="search-overlay__section-title">General Information</h2>
        //         ${combinedResults.length ? '<ul class="link-list min-list">' : '<p>No general information available</p>'}
