...
<html>
  ...
  <body <?php body_class(); ?>>
    <header class="site-header">
      <div class="container">
        <h1 class="school-logo-text float-left"><a href="<?php echo site_url(); ?>"><strong>Monsters</strong> University</a></h1>
        ...
        <div class="site-header__menu group">
          ...
          <div class="site-header__util">
            <?php if(is_user_logged_in()){ ?>
                ...
                <a href="<?php echo esc_url(site_url('/wp-admin'));?>" class="btn btn--small btn--orange float-left push-right">Login</a>
